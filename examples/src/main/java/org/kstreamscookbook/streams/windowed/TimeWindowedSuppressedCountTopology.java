 ...
 */
public class TimeWindowedSuppressedCountTopology implements Supplier<Topology> {
    ...
    public TimeWindowedSuppressedCountTopology(String sourceTopic, String targetTopic) {
    ...
    public Topology get() {
        ...
        builder.stream(sourceTopic, Consumed.with(stringSerde, stringSerde))
                ...
                .count(Materialized.as("csv-aggregation-store").with(stringSerde, longSerde))
