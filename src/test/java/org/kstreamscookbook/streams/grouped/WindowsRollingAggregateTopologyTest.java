...
public class WindowsRollingAggregateTopologyTest extends TopologyTestBase {
  ...
  protected TopologyBuilder withTopologyBuilder() {
    // Window of 5 min width sliding by 1 min
  ...
  public void testWindowedAggregation() {
    ...
    testDriver.pipeInput(factory.create(INPUT_TOPIC, "a", "60s", start.plus(3, ChronoUnit.SECONDS).toEpochMilli()));
