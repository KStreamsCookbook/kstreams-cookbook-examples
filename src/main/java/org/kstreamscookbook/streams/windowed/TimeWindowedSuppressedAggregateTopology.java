 ...
 */
public class TimeWindowedSuppressedAggregateTopology implements Supplier<Topology> {
    ...
    public TimeWindowedSuppressedAggregateTopology(String sourceTopic, String targetTopic) {
    ...
    public Topology get() {
        ...
        builder.stream(sourceTopic, Consumed.with(stringSerde, stringSerde))
                ...
                .aggregate(() -> "",
                        ...
                        Materialized.as("csv-suppressed-aggregation-store").with(stringSerde, stringSerde))
